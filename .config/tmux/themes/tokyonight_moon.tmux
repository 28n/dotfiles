# Generated from folke/tokyonight.nvim's official tmux extra (Moon style).
...
set -g status-right "#[fg=#3b4261,bg=#1e2030]#[fg=#82aaff,bg=#3b4261] %Y-%m-%d  %H:%M #[fg=#82aaff,bg=#3b4261]#[fg=#1b1d2b,bg=#82aaff,bold] #h "
